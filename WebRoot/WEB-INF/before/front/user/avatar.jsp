...
<head>
    ...
    <title>在线公开课一根筋教育|java|大数据|HTML5|python|UI|PHP视频教程</title>
</head>
                    ...
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
                            ...
                            <c:if test="${not empty user.imgurl}">
                                  <img width="200px" height="200px" src="http://localhost:8081/img/${user.imgurl}">
                            </c:if>
                        ...
                        <div class="profile_ifo_area">
                            <form id="upload_form" enctype="multipart/form-data" method="post" action="user/upLoadImage.action" >
                                <!-- hidden crop params -->
